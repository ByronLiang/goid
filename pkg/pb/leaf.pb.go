...
var file_leaf_proto_rawDesc = []byte{
	...
	,
}
...
var file_leaf_proto_depIdxs = []int32{
	...
	0, // 1: pb.Leaf.Stop:input_type -> pb.LeafRequest
	1, // 2: pb.Leaf.Query:output_type -> pb.LeafResponse
	2, // 3: pb.Leaf.Stop:output_type -> google.protobuf.Empty
...
type LeafClient interface {
	...
	Stop(ctx context.Context, in *LeafRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *leafClient) Stop(ctx context.Context, in *LeafRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/pb.Leaf/Stop", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LeafServer interface {
	...
	Stop(context.Context, *LeafRequest) (*empty.Empty, error)
}
...
func (*UnimplementedLeafServer) Stop(context.Context, *LeafRequest) (*empty.Empty, error) {
...
func _Leaf_Stop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.Leaf/Stop",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LeafServer).Stop(ctx, req.(*LeafRequest))
	}
	return interceptor(ctx, in, info, handler)
}
